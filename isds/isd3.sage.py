...
# This file was *autogenerated* from the file isd3.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_22 = Integer(22); _sage_const_11 = Integer(11); _sage_const_5 = Integer(5); _sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_6 = Integer(6); _sage_const_3 = Integer(3)
import random
...
if __name__ == "__main__":
    print("----- ISD Algorithm -----")
    H = generate_random_ldpc(r,n,_sage_const_6 ,_sage_const_3 )
    minimum_distance_codewords = isd_stern(H, l)
    sample_codeword = minimum_distance_codewords[_sage_const_0 ]
