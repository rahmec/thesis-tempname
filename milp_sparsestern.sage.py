...
# This file was *autogenerated* from the file milp_sparsestern.sage
from sage.all_cmdline import *   # import sage library

_sage_const_0p5 = RealNumber('0.5'); _sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_0p95 = RealNumber('0.95'); _sage_const_0p05 = RealNumber('0.05'); _sage_const_0p80 = RealNumber('0.80'); _sage_const_0p2 = RealNumber('0.2'); _sage_const_10 = Integer(10); _sage_const_3 = Integer(3); _sage_const_200 = Integer(200)
import random
import logging
import time
...
def choose_l1(H):
	...
	# Get the results
	selected_rows = [i for i in range(r) if p.get_values(x[i]) > _sage_const_0p5 ]
	activated_columns = [j for j in range(n) if p.get_values(z[j]) > _sage_const_0p5 ]
...
def enum_vec_w_p(size, p):
    ...
    vectors = [vector(GF(_sage_const_2 ), perm) for perm in perms]
    return vectors
