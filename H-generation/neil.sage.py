...
# This file was *autogenerated* from the file neil.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_800 = Integer(800); _sage_const_1200 = Integer(1200); _sage_const_600 = Integer(600); _sage_const_400 = Integer(400)
import random
...
H = generate_matrix(_sage_const_800 ,_sage_const_1200 ,_sage_const_600 ,_sage_const_400 ) 
print(len([a for a in H.list() if a]))
for row in H:
    if len([a for a in row.list() if a]) != _sage_const_600 :
