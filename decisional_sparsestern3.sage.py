...
# This file was *autogenerated* from the file decisional_sparsestern3.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_0p95 = RealNumber('0.95'); _sage_const_0p05 = RealNumber('0.05'); _sage_const_0p80 = RealNumber('0.80'); _sage_const_0p2 = RealNumber('0.2'); _sage_const_25 = Integer(25); _sage_const_10 = Integer(10); _sage_const_20 = Integer(20); _sage_const_3 = Integer(3); _sage_const_1000 = Integer(1000)
import random
import logging
import numpy as np
...
def sparseStern(H2):
	...
	p1 = ceil(z1/_sage_const_25 )
	p2 = ceil((k+l-z)/_sage_const_25 )
	p3 = p1 + p2
	p = p1 + p2 + p3
		...
		for comb12 in combs12:
			...
			if x11*A1.T == -x12*A2.T:
				...
				for comb2 in combs22:
					x21 = vector(GF(_sage_const_2 ), list(x11) + list(x12))
					x22 = vector(GF(_sage_const_2 ), k+l-z)
					for j in comb2:
						x22[j] = _sage_const_1 
					#print(x22)
					#print(x11)
					...
					if x21*B1.T == -x22*B2.T:
						...
						collisions += _sage_const_1 ;
						x31 = vector(GF(_sage_const_2 ), list(x21) + list(x22))
						x32 = -x31 * C.T
						x = vector(GF(_sage_const_2 ), list(x31) + list(x32))
						w = x.hamming_weight()
